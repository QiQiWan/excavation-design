...
HEAVY_TASK_CONCURRENCY="${PITGUARD_HEAVY_TASK_CONCURRENCY:-}"
...
RESOURCE_POLICY_MODE="${PITGUARD_RESOURCE_POLICY_MODE:-adaptive}"
API_FULL_PROJECT_HARD_CAP_MB="${PITGUARD_API_FULL_PROJECT_HARD_CAP_MB:-2048}"
WORKSPACE_PAYLOAD_HARD_CAP_MB="${PITGUARD_WORKSPACE_PAYLOAD_HARD_CAP_MB:-256}"
...
PITGUARD_RESOURCE_POLICY_MODE=$RESOURCE_POLICY_MODE
PITGUARD_API_FULL_PROJECT_HARD_CAP_MB=$API_FULL_PROJECT_HARD_CAP_MB
PITGUARD_WORKSPACE_PAYLOAD_HARD_CAP_MB=$WORKSPACE_PAYLOAD_HARD_CAP_MB
