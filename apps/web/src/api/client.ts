...
export const api = {
  ...
  exportUrl: (projectId: string, kind: 'ifc' | 'ifc-light' | 'ifc-analysis' | 'ifc-construction-visual' | 'ifc-detailed' | 'drawings-cad' | 'drawings-svg' | 'report' | 'json' | 'design-scheme-ledger' | 'rebar-detailing-package') => `${API_BASE}/api/projects/${projectId}/export/${kind}`,
